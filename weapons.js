...
const Weapons = (() => {
  ...
  let currentIdx = 0;
  let unlocked   = [true, true, false, false, false, false, false, false, false];
  ...
  function spawnProjectile(camera, wep) {
    ...
    _scene.add(mesh);
    projectiles.push({
      mesh, dir: dir.clone(), speed: PROJ_SPEED,
  ...
  function reset() {
    ...
    currentIdx = 0;
    unlocked   = [true, true, false, false, false, false, false, false, false];
    if (zoomed) exitZoom();
    recoilOffset = 0;
    reloadAnimAngle = 0;
    swingTimer = 0;
